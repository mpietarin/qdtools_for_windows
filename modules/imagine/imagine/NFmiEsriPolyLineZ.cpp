...
NFmiEsriPolyLineZ::NFmiEsriPolyLineZ(const NFmiEsriPolyLineZ& theLine)
    : NFmiEsriPolyLineM(theLine),
...
NFmiEsriPolyLineZ& NFmiEsriPolyLineZ::operator=(const NFmiEsriPolyLineZ& theLine)
{
  if (this != &theLine)
  {
    NFmiEsriPolyLineM::operator=(theLine);
    itsBox = theLine.itsBox;
    itsParts = theLine.itsParts;
    itsPoints = theLine.itsPoints;
  }
...
NFmiEsriElement* NFmiEsriPolyLineZ::Clone() const { return new NFmiEsriPolyLineZ(*this); }
// ----------------------------------------------------------------------
...
NFmiEsriPolyLineZ::NFmiEsriPolyLineZ(const string& theBuffer, int thePos, int theNumber)
    : NFmiEsriPolyLineM(theNumber, kFmiEsriPolyLineZ), itsBox(), itsParts(), itsPoints()
{
...
std::ostream& NFmiEsriPolyLineZ::Write(ostream& os) const
{
