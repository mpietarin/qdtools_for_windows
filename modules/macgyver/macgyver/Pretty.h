// ======================================================================
/*!
 * \brief STL container pretty printer by Steven J. Lavajev
 *
 * Found by following the link at: http://louisdx.github.io/cxx-prettyprint/
 */
// ======================================================================
...
void print_tuple_helper(std::ostream& os,
                        const Tuple& t,
                        const Fmt& fmt,
...
template <typename Tuple, typename Fmt>
void print_tuple_helper(std::ostream&, const Tuple&, const Fmt&, std::integral_constant<size_t, 0>)
{
}
...
template <typename T, typename Fmt>
void pretty_print(std::ostream& os, const T& t, const Fmt& fmt)
{
  print(os, t, fmt);
  os << std::endl;
}
