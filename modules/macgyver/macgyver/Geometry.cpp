...
double GeoDistance(double theLon1, double theLat1, double theLon2, double theLat2)
{
  ...
  double lo1 = Radians(theLon1);
  double la1 = Radians(theLat1);

  double lo2 = Radians(theLon2);
  double la2 = Radians(theLat2);
...
{
  double lon1 = Radians(theLon1);
  double lat1 = Radians(theLat1);
  double lon2 = Radians(theLon2);
  double lat2 = Radians(theLat2);
